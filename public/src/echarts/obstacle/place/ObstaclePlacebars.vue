<template>
	<div :style="{ width: '100%', height: heightData }" class="justifyBetween">
		...
		<div id="ObstaclePlacebars" :style="{ width: '70%', height: '100%' }"></div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			ObstaclePlacebarsChart() {
				try {
					if (!document.getElementById('ObstaclePlacebars')) {
						return;
					}
					...
					this.malfunctionEchart = echarts.init(document.getElementById('ObstaclePlacebars'), null, {
