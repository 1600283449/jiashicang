<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="inspectionslinechart" style="width:65%;height:100%;margin-left: 1.17186vw;"></div>
			<div class="table">
				<div class="title flexAlignCenter">维保结果</div>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('inspectionslinechart')) {

					}
					this.options.series[0].data = this.trappedLists
					this.faultSourcelinEcharts = echarts.init(document.getElementById('inspectionslinechart'),
						null, {
