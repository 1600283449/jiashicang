		...
		<div class="contents">
			<div class="title">
				<div class="titles justifyBetween">
					<div class="titleLeft flexAlignCenter">
						...
						<div class="name">行为分析（本月）</div>
					</div>
					<div class="TitleRight" @click="homePageClick()">
						详细统计 >
					</div>
				</div>
			</div>
			<div class="trappedContents" v-if="trappedContentsState"  @mouseleave="handleMouseLeave" @mouseenter="handleMouseEnter">
				<div class="allTitle flexcenter">
					<div class="allTitles behaviorTitles flexDirectionCenter" v-for="v in behaviorList" @click="mytableClick()">
				...
				<div class="echartsmap">
					<behaviorlines :heightData="heightData" :options="lineOptions" v-if="behaviorStates==1">
					</behaviorlines>
					<behaviorpie :heightData="heightData" :options="chartOptions" v-if="behaviorStates==2">
					</behaviorpie>
					<timecharts :heightData="heightData" :options="malfunctionOptions" v-if="behaviorStates==3">
					</timecharts>
				</div>
			</div>
			<div class="trappedplace" v-else  @mouseleave="placeMouse" @mouseenter="placeMouseEnter">
				...
				<div class="echartsmap">
					<behaviorPlaceLine :heightData="heightData" :options="lineOptions" v-if="placeState==1">
					</behaviorPlaceLine>
					<behaviorPlacePie :heightData="heightData" :options="chartOptions" v-if="placeState==2"></behaviorPlacePie>
					<behaviorPlacebars :heightData="heightData" :options="placebarsOptions" v-if="placeState==3"></behaviorPlacebars>
				</div>
			</div>
		</div>
		<div class="select">
...
<script>
	import behaviorpie from '@/echarts/behavior/behaviorpie';
	import timecharts from '@/echarts/behavior/timecharts';
	import behaviorlines from '@/echarts/behavior/behaviorlines';
	import behaviorPlacebars from "@/echarts/behavior/place/behaviorPlacebars"
	import behaviorPlaceLine from "@/echarts/behavior/place/behaviorPlaceLine"
	import behaviorPlacePie from "@/echarts/behavior/place/behaviorPlacePie"
	import {
	...
	export default {
		...
		methods: {
			...
			homePageClick(){
				this.$store.commit('obstacleDrawers', true);
			},
			// 场所一揽
			placeUpdate() {
