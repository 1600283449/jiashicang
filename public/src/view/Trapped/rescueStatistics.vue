<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="rescuelinechart" style="width: 100%;height: 90%;margin-left: 30px;"></div>
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('rescuelinechart')) {
					...
					this.rescuelinEchart = echarts.init(document.getElementById('rescuelinechart'), null, {
