<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="rescuelinecharts" style="width: 44%;height: 90%;margin-left: 30px;"></div>
			<div class="table">
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('rescuelinecharts')) {
					...
					this.linemyEcharts = echarts.init(document.getElementById('rescuelinecharts'), null, {
