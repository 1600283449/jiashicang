<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="obstaclerescuelinechart" style="width: 100%;height: 90%;margin-left: 30px;"></div>
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('obstaclerescuelinechart')) {
					...
					this.rescuelinEchart = echarts.init(document.getElementById('obstaclerescuelinechart'), null, {
