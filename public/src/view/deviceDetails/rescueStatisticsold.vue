<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="devicerescuelinechart" style="width: 100%;height: 90%;margin-left: 30px;"></div>
		</div>
	</div>
</template>
		...
		methods: {
			initCharts() {
				try {
					...
					this.rescuelinEchart = echarts.init(document.getElementById('devicerescuelinechart'), null, {
