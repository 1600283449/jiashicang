		...
		<div class="contents">
			<div class="title">
				<div class="titles justifyBetween">
					<div class="titleLeft flexAlignCenter">
						...
						<div class="name">公众监督(本月)</div>
					</div>
				<!-- 	<div class="TitleRight" @click="supervise()">
						详细统计 >
					</div> -->
				</div>
			</div>
			<div class="trappedContents" v-if="trappedContentsState"  @mouseleave="handleMouseLeave" @mouseenter="handleMouseEnter">
				<div class="allTitle flexcenter">
					<div class="allTitles flexDirectionCenter" v-for="v in behaviorList" style="width: 25%;"  @click="mytableClick()">
				...
				<div class="echartsmap">
					<superviselines :heightData="heightData" :options="lineOptions" v-if="behaviorStates==1">
					</superviselines>
					<supervisepie :heightData="heightData" :options="chartOptions" v-if="behaviorStates==2">
					</supervisepie>
					<superviseslines :heightData="heightData" :options="lineOptions" v-if="behaviorStates==3">
					</superviseslines>
					<supervise :heightData="heightData" :options="malfunctionOptions" v-if="behaviorStates==4">
					</supervise>
				</div>
			</div>
			<div class="trappedplace" v-else  @mouseleave="placeMouse" @mouseenter="placeMouseEnter">
				...
				<div class="echartsmap">
					<supervisePlaceLine :heightData="heightData" :options="lineOptions" v-if="placeState==1">
					</supervisePlaceLine>
					<supervisePlacePie :heightData="heightData" :options="chartOptions" v-if="placeState==2"></supervisePlacePie>
					<supervisePlacebars :heightData="heightData" :options="placebarsOptions" v-if="placeState==3"></supervisePlacebars>
				</div>
			</div>
		</div>
	</div>
...
<script>
	import supervisepie from '@/echarts/supervise/supervisepie';
	import superviselines from '@/echarts/supervise/superviselines';
	import superviseslines from '@/echarts/supervise/superviseslines';
	import supervise from '@/echarts/supervise/supervise';
	
	
	import supervisePlacebars from "@/echarts/supervise/place/supervisePlacebars"
	import supervisePlaceLine from "@/echarts/supervise/place/supervisePlaceLine"
	import supervisePlacePie from "@/echarts/supervise/place/supervisePlacePie"
	import {
