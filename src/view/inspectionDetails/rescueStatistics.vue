<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="inspectionrescuelinechart" style="width: 44%;height: 90%;margin-left: 30px;"></div>
			<div class="table">
				<div class="title flexAlignCenter">检验检测统计</div>
		...
		methods: {
			initCharts() {
				try {
					...
					this.linemyEcharts = echarts.init(document.getElementById('inspectionrescuelinechart'), null, {
