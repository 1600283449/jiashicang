<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="reasonchart" style="width:65%;height:100%;margin-left: 1.17186vw;"></div>
			<div class="table">
				<div class="title flexAlignCenter">检验检测机构列表</div>
		...
		methods: {
			initCharts() {
				try {
					...
					this.faultSourcelinEcharts = echarts.init(document.getElementById('reasonchart'),
						null, {
