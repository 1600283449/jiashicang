<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="inspectionlinecharts" style="width: 44%;height: 90%;margin-left: 30px;"></div>
			<div class="table">
				<div class="title flexAlignCenter">电梯维保列表</div>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('inspectionlinecharts')) {
					...
					this.linemyEcharts = echarts.init(document.getElementById('inspectionlinecharts'), null, {
