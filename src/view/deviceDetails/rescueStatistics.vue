<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="devicerescuelinechart" style="width: 44%;height: 90%;margin-left: 30px;"></div>
			<div class="table">
				<div class="title flexAlignCenter">设备统计列表</div>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('devicerescuelinechart')) {
					...
					this.linemyEcharts = echarts.init(document.getElementById('devicerescuelinechart'), null, {
