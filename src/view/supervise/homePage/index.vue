			...
			<div class="trappedContents" v-if="trappedContentsState"  @mouseleave="handleMouseLeave" @mouseenter="handleMouseEnter">
				...
				<div class="mapSelect flexAlignCenter">
					<div class="mapSelects flexcenter" v-for="(v,i) in behaviorState"
						:class="{ 'mapSelects': v.state, 'nomapSelects': !v.state }"  style="width:25%"
				...
				<div class="echartsmap">
					...
					<superviseslines :heightData="heightData" :options="lineOptions" v-if="behaviorStates==2">
					</superviseslines>
					<supervisepie :heightData="heightData" :options="chartOptions" v-if="behaviorStates==3">
					</supervisepie>
