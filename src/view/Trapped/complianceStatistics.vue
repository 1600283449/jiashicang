<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="compliancelinechart" style="width: 100%;height: 90%;margin-left: 1.17186vw;"></div>
		</div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('compliancelinechart')) {
					...
					this.compliancelineEchart = echarts.init(document.getElementById('compliancelinechart'), null, {
