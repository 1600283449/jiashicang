<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="obstaclelinecharts" style="width: 44%;height: 90%;margin-left: 30px;"></div>
			<div class="table">
				<div class="title flexAlignCenter">阻梯故障统计列表</div>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('obstaclelinecharts')) {
					...
					this.linemyEcharts = echarts.init(document.getElementById('obstaclelinecharts'), null, {
