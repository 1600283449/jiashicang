<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="obstaclelinechart" style="width:65%;height:100%;margin-left: 1.17186vw;"></div>
			<div class="table">
				<div class="title flexAlignCenter">阻梯事件不文明行为列表</div>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('obstaclelinechart')) {

					}
					this.options.series[0].data = this.trappedList
					this.faultSourcelinEcharts = echarts.init(document.getElementById('obstaclelinechart'),
						null, {
