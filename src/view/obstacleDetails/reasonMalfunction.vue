<template>
	<div class="trappedStatistics">
		...
		<div class="Statistics justifyBetween">
			<div id="obstaclereasonchart" style="width:65%;height: 90%;margin-left: 0.79vw;margin-top:  0.3950vw;"></div>
			<div class="table">
				<div class="title flexAlignCenter">阻梯时段分析</div>
...
<script>
	...
	export default {
		...
		methods: {
			initCharts() {
				try {
					if (!document.getElementById('obstaclereasonchart')) {
					...
					this.reasonEcharts = echarts.init(document.getElementById('obstaclereasonchart'),
						null, {
