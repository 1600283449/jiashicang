<template>
	<div class="center">
		<div class="statistics justifyBetween">
			<div class="newStatistics justifyAround" @mouseenter="mouseenter(v)" @mouseleave="mouseleave(v)">
				<div class="newStatisticsS flexDirectionCenter" v-for="(v,i) in statisticsList.trapped"  @click="trappedDisposeClick(v)">
