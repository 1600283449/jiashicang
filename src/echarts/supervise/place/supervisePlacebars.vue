<template>
	<div :style="{ width: '100%', height: heightData }" class="justifyBetween">
		...
		<div id="supervisePlacebarschart" :style="{ width: '70%', height: '100%' }"></div>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			supervisePlacebarsChart() {
				try {
					if (!document.getElementById('supervisePlacebarschart')) {
						return;
					}
					...
					this.malfunctionEchart = echarts.init(document.getElementById('supervisePlacebarschart'), null, {
